 ...
 */
export async function getCwarWalletBalance(walletPublicKey: PublicKey): Promise<BN> {
  ...
  return new BN(balance.value.uiAmount ?? 0);
}

export async function getStakingTokenWalletBalance(walletPublicKey: PublicKey): Promise<BN> {
  const connection = ConnectionService.getConnection();
...
export async function getRewardTokenWalletBalance(walletPublicKey: PublicKey): Promise<BN> {
  const connection = ConnectionService.getConnection();
...
export async function getStakingVaultBalance(): Promise<BN> {
  const connection = ConnectionService.getConnection();
  let balance;
...
export async function getRewardsVaultBalance(): Promise<BN> {
  const connection = ConnectionService.getConnection();
  let balance;
